...
public class Action_Murder : ProppAction
{
    public const string key = "murder";
    ...
    {
        return $"{performChar}이(가) {targetChar}을(를) 죽였습니다.";
    }
    public override string DescriptionAsNoun()
    {
        return $"{performChar}이(가) {targetChar}을(를) 죽인 것";
    }
